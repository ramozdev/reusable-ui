...
export default function NavigationMenuDemo() {
  ...
  return (
    <div>
      <Text.H3>Navigation Menu</Text.H3>
      {/* <div className="grid grid-cols-2 gap-y-4 overflow-x-clip"> */}
      <div className="flex w-2/3">
        ...
        >
          {colors.map((color) => (
            <option key={`navigation-${color}`} value={color}>
              {color}
            </option>
          ))}
        </Select>
        <div className="flex justify-start overflow-x-clip">
          <NavigationMenu.Root>
            <NavigationMenu.List color={color}>
              <NavigationMenu.Item>
